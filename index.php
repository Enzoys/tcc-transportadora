    ...
    <div style="background-color: #161500; height: 265px; width: 100%; margin: 0;">
        <div id="divImg1" style="background-color: aqua; height: 100%; width: 80%; margin: 0 10%;text-align: center">
            <div style="padding-top: 90px">
                <h1 style="text-shadow: 2px 2px #fff500,-2px -2px #fff500,2px -2px #fff500,-2px 2px #fff500">Acesse agora e solicite um transporte!</h1>
            </div>
            <div>
...
<div style="background-color: #d23123;" >
    <div style="height: 100%; min-height: 300px; margin: 0 15%;">
        <div style="background-color: #ccc400; height: 100%; min-height: 300px; width: 50%; margin: 0;float:right;">
        </div>        
    
        <div style="background-color: #eee500; height: 100%; width: 50%; min-height: 300px; margin: 0;">
            <h2>Contate-nos!</h2>
        </div>
    </div>
</div>

<div class="texto-claro" style="background-color: #161500; height: 100%; min-height: 450px; width: 100%;">
    <div style="text-align: center; padding-top: 70px;color">
        <h1>Sobre a Invicta-X</h1>
