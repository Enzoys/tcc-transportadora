...
<div id="tb_div" style="display: inline-block; width: 100%; background-color: #fff500;">
    ...
    <div id="tbc_div" style="width: 50%; display: table; font-family: Helvetica, Arial, sans-serif;">
        <div style="display: table-cell; vertical-align: middle; padding: 0 50px; height: 50%; width:100%;">
...
<div style="background-color: white; height: 100%; min-height: 600px; width: 100%; margin: 0;">
    <div style="background-color: white; height: 265px; width: 100%; margin: 0;">
...
<div class="branca" style="background-color: black; height: 100%; min-height: 680px; width: 100%;">
    <div style="text-align: center; padding-top: 70px;padding-botton:60px">
        <h1>NOSSA HISTÓRIA</h1>
        <div style="text-align: center; padding-top: 20px; width: 50%; margin: 0 25%;">
            <h2>
